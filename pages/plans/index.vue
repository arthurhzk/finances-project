  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
        ...
        >
          Desenvolvendo um sistema que fará parte do seu time de gestão.
        </h2>
        <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
          Aqui na WiseHub nos preocupamos em entregar a você o melhor serviço do
          mercado a um preço acessível.
        </p>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          <div class="flex justify-center items-baseline my-8">
            <span class="mr-2 text-5xl font-extrabold">R$29</span>
          ...
          <ul role="list" class="mb-8 space-y-4 text-left">
            ...
            <li class="flex items-center space-x-3">
              ...
              <span
                >Equipe: <span class="font-semibold">1 developer</span></span
              >
            </li>
            <li class="flex items-center space-x-3">
              <!-- Icon -->
              ...
              <span
                >Atendimnento especializado:
                <span class="font-semibold">6 meses</span></span
              >
            </li>
            <li class="flex items-center space-x-3">
              <!-- Icon -->
        ...
        >
          ...
          <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            Relevante para múltiplos usuáriosr
          </p>
          <div class="flex justify-center items-baseline my-8">
            <span class="mr-2 text-5xl font-extrabold">R$99</span>
            <span class="text-gray-500 dark:text-gray-400">/Mês</span>
          </div>
          <!-- List -->
          <ul role="list" class="mb-8 space-y-4 text-left">
            ...
            <li class="flex items-center space-x-3">
              ...
              <span
                >Equipe: <span class="font-semibold">10 developers</span></span
              >
            </li>
            <li class="flex items-center space-x-3">
              <!-- Icon -->
              ...
              <span
                ...
                <span class="font-semibold">24 meses</span></span
              >
            </li>
            <li class="flex items-center space-x-3">
              <svg
        ...
        >
          ...
          <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            Melhor para usos em grande escala e direitos de redistribuição
            estendidos.
          </p>
          <div class="flex justify-center items-baseline my-8">
          ...
          <ul role="list" class="mb-8 space-y-4 text-left">
            ...
            <li class="flex items-center space-x-3">
              ...
              <span
                >Atendimento especializado:
                <span class="font-semibold">36 meses</span></span
              >
            </li>
            <li class="flex items-center space-x-3">
              <svg
